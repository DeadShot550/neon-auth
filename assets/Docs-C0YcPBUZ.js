...
class Program
{
    static async Task Main()
    {
        ...
        var auth = new NeonAuth(
            ...
            baseUrl: "https://neonauth.vercel.app"
        );
...
int main()
{
    ...
    NeonAuth::Client auth(
        ...
        "https://neonauth.vercel.app" // API Base URL
    );
...
auth = NeonAuth(
    ...
    base_url="https://neonauth.vercel.app"
)
